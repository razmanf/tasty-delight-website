...
<head>
    ...
    <style>
        ...
        .badge { background-color: #fecaca; color: #991b1b; padding: 4px 10px; border-radius: 9999px; font-size: 12px; font-weight: bold; display: inline-block; margin-bottom: 15px; }
        ...
        @media (prefers-color-scheme: dark) {
            ...
            .badge { background-color: #991b1b !important; color: #fecaca !important; }
        }
...
<body>
    <div class="container">
        ...
        <div style="text-align: center;">
            ...
            <h2 style="margin-top: 0; color: #111827;">Order Cancelled</h2>
            <h3 style="margin-top: 5px; color: #6b7280; font-weight: normal;">Order Receipt #{{ $order->id }}</h3>
        </div>
        
        <p>Hi {{ $order->user->name }},</p>
        
        <p>We are writing to let you know that your order #{{ $order->id }} has unfortunately been cancelled. We sincerely apologize for any inconvenience this may cause.</p>
        
        <p>If you paid online via card, a full refund has been initiated and should reflect in your account within 3-5 business days. If you opted for Cash on Delivery, no charges have been applied.</p>
        
        <div class="details-card">
            <h3 style="margin-top:0; font-size: 14px; text-transform:uppercase; letter-spacing:1px; color:#6b7280; border-bottom:1px solid #e5e7eb; padding-bottom:10px; margin-bottom:15px;">Original Order Details</h3>
            <table class="table">
            ...
            <div class="summary-row summary-total">
                <div class="summary-label" style="color: #DD6625;">Total</div>
                <div class="summary-value">${{ number_format($order->total_amount, 2) }}</div>
            </div>
        </div>
        
        <div style="text-align:center">
            <a href="{{ url('/user/menu') }}" class="btn" style="color: #ffffff; text-decoration: none;">Browse Our Menu Again</a>
        </div>
        
        <p style="margin-top: 30px; font-size: 12px; color: #6b7280; text-align: center;">
            We hope to serve you soon! If you have any questions, please contact our support team.
        </p>
    </div>
</body>
</html>
